...
`;
  ...
  restoreOntology(refinedBody, ontology) {
    ...
    const hasMissingOntology = missingLinks.length > 0 || missingTags.length > 0 || missingHandles.length > 0 || missingExtLinks.length > 0 || missingImages.length > 0;
